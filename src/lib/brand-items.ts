...
export const BRAND_LOCATIONS: BrandLocation[] = [
  // ---------- Bottom of Lenoir food court ----------
  {
    ...
    items: [
      ...
      {
        name: "Hash Brown Scramble Bowl with Grilled Chicken",
        station: "Breakfast",
        calories: 470,
        proteinG: 33,
        totalCarbsG: 24,
  ...
  },
  {
    ...
    items: [
      ...
      {
        name: "Loaded Nachos with Chicken",
        station: "Sides",
        calories: 760,
        proteinG: 32,
        totalCarbsG: 70,
  ...
  // ---------- Chase area ----------
  {
    ...
    items: [
      ...
      {
        name: "Meatball Marinara 6\" on Italian Herbs & Cheese",
        station: "Subs",
        calories: 480,
        proteinG: 21,
        totalCarbsG: 60,
        ...
        sodiumMg: 1080,
        servingSize: "6 inch",
        allergens: ["wheat", "milk", "egg", "soy", "gluten"],
      },
      {
